...
Official Go client for the Atulya API, generated from the OpenAPI 3.1 spec using [OpenAPI Generator](https://github.com/OpenAPITools/openapi-generator).
...
```bash
go get github.com/eight-atulya/atulya/atulya-clients/go
```
...
The Go client provides access to all Atulya API operations through structured namespaces:
...
- [OpenAPI specification](https://atulya.dev/openapi.json) - Complete API reference
