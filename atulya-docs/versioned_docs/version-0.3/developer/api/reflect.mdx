...
When you call **reflect**, Atulya performs a multi-step reasoning process:
...
```javascript
import { Atulya } from "@anthropic-ai/atulya";

const client = new Atulya();
