#!/usr/bin/env node
/**
 * Opinions API examples for Atulya (deprecated - kept for versioned docs).
...
const client = new AtulyaClient({ baseUrl: ATULYA_URL });
...
await fetch(`${ATULYA_URL}/v1/default/banks/skeptical-bank`, { method: 'DELETE' });
