...
| `ATULYA_API_CONSOLIDATION_MAX_COMPLETION_TOKENS` | Maximum LLM output tokens for a single consolidation batch call. Lower this for slower local models that otherwise over-generate and time out. Configurable per bank. | `1024` |
