...
Atulya uses PostgreSQL as its sole storage backend.
...
Atulya does not abstract storage behind a generic interface. This is a deliberate trade-off.
...
For local development, Atulya uses **[pg0](https://github.com/eight-atulya/pg0)**—an embedded PostgreSQL distribution.
...
Any PostgreSQL instance that satisfies these requirements should work. If you encounter issues with a specific setup, [open a GitHub issue](https://github.com/eight-atulya/atulya/issues).
