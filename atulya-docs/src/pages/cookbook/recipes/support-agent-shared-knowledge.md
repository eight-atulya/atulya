...
[**Open in GitHub →**](https://github.com/eight-atulya/atulya-cookbook/blob/main/notebooks/03-support-agent-shared-knowledge.ipynb)
:::
...
print(f"View documents: {ATULYA_UI_URL}/banks/product-docs?view=documents")
```
...
print(f"\nView user memory: {ATULYA_UI_URL}/banks/user-bob?view=documents")
```
