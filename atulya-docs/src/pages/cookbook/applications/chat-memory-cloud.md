...
[**View source on GitHub →**](https://github.com/eight-atulya/atulya-cookbook/tree/main/applications/chat-memory-cloud)
:::


A demo chat application with persistent per-user memory powered by [Atulya Cloud](https://atulya.eightengine.com). Supports OpenAI or Groq as the LLM provider. No local Atulya server required.
...
- **Atulya** — Sign up at https://atulya.eightengine.com
...
4. **Memory Verification**: Log in to the [Atulya dashboard](https://atulya.eightengine.com) to see stored memories
...
| `ATULYA_API_KEY` | — | Your Atulya API key |
