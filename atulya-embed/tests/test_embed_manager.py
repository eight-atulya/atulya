...
def test_sanitize_profile_name_via_db_url():
    ...
    assert manager.get_database_url(None) == "pg0://atulya-embed-default"

    # Test simple alphanumeric names
    assert manager.get_database_url("myapp") == "pg0://atulya-embed-myapp"
    assert manager.get_database_url("my-app") == "pg0://atulya-embed-my-app"
    assert manager.get_database_url("my_app") == "pg0://atulya-embed-my_app"
    assert manager.get_database_url("app123") == "pg0://atulya-embed-app123"

    # Test special characters get replaced with dashes
    assert manager.get_database_url("my app") == "pg0://atulya-embed-my-app"
    assert manager.get_database_url("my.app") == "pg0://atulya-embed-my-app"
    assert manager.get_database_url("my@app!") == "pg0://atulya-embed-my-app-"
    assert manager.get_database_url("My App 2.0!") == "pg0://atulya-embed-My-App-2-0-"
...
def test_get_database_url_default():
    ...
    assert manager.get_database_url("myapp") == "pg0://atulya-embed-myapp"
    assert manager.get_database_url("myapp", None) == "pg0://atulya-embed-myapp"
    assert manager.get_database_url("myapp", "pg0") == "pg0://atulya-embed-myapp"
