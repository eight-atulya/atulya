"""
Clean, pythonic wrapper for the Atulya API client.
...
from atulya_client_api.api import banks_api, directives_api, files_api, memory_api, mental_models_api
...
class Atulya:
    """
    High-level, easy-to-use Atulya API client.
    ...
    Example:
        ...
        client = Atulya(base_url="http://localhost:8888", api_key="your-api-key")
    ...
    def __init__(self, base_url: str, api_key: str | None = None, timeout: float = 300.0):
        """
        Initialize the Atulya client.

        Args:
            base_url: The base URL of the Atulya API server
            api_key: Optional API key for authentication (sent as Bearer token)
            timeout: Request timeout in seconds (default: 300.0)
        """
        config = atulya_client_api.Configuration(host=base_url, access_token=api_key)
        self._api_client = atulya_client_api.ApiClient(config)
    ...
    def create_mental_model(
        ...
        """
        from atulya_client_api.models import create_mental_model_request, mental_model_trigger
    ...
    def update_mental_model(
        ...
        Returns:
            MentalModelResponse
        """
        from atulya_client_api.models import mental_model_trigger, update_mental_model_request
    ...
    def create_directive(
        ...
        Returns:
            DirectiveResponse
        """
        from atulya_client_api.models import create_directive_request
    ...
    def update_directive(
        ...
        Returns:
            DirectiveResponse
        """
        from atulya_client_api.models import update_directive_request
