"""
Tests for Atulya Python client.
...
@pytest.fixture
def client():
    """Create a Atulya client for testing."""
    with Atulya(base_url=ATULYA_API_URL) as client:
        yield client
...
class TestBankStats:
    ...
    async def test_get_bank_stats(self, client, bank_id):
        ...
        from atulya_client_api.api import BanksApi

        config = Configuration(host=ATULYA_API_URL)
...
class TestOperations:
    ...
    async def test_list_operations(self, client, bank_id):
        ...
        from atulya_client_api import ApiClient, Configuration
        from atulya_client_api.api import OperationsApi
...
class TestEntities:
    ...
    def test_list_entities(self, client, bank_id):
        ...
        from atulya_client_api import ApiClient, Configuration
        from atulya_client_api.api import EntitiesApi
