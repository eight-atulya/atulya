...
class DirectGrantRequest(BaseModel):
    ...
    scope_id: StrictStr
    __properties: ClassVar[List[str]] = ["principal_id", "action", "scope_type", "scope_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DirectGrantRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DirectGrantRequest from a dict"""
        if obj is None:
            return None
