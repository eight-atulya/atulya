...
class WorkerStatusResponse(BaseModel):
    ...
    stuck_count: StrictInt
    last_seen_at: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["worker_id", "schema_name", "pending_count", "stuck_count", "last_seen_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkerStatusResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkerStatusResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "stuck_count": obj.get("stuck_count"),
