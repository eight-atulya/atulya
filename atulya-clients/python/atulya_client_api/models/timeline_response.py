...
class TimelineResponse(BaseModel):
    ...
    TimelineResponse
    """ # noqa: E501
    items: Optional[List[TimelineItemResponse]] = None
    edges: Optional[List[TimelineEdgeResponse]] = None
    total_items: StrictInt
    limit: StrictInt
    __properties: ClassVar[List[str]] = ["items", "edges", "total_items", "limit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [TimelineItemResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "edges": [TimelineEdgeResponse.from_dict(_item) for _item in obj["edges"]] if obj.get("edges") is not None else None,
