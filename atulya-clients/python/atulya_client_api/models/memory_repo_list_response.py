...
class MemoryRepoListResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemoryRepoListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemoryRepoListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "repos": [MemoryRepoSummaryResponse.from_dict(_item) for _item in obj["repos"]] if obj.get("repos") is not None else None
        })
        return _obj
