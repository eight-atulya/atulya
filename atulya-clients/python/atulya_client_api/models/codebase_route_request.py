...
class CodebaseRouteRequest(BaseModel):
    ...
    def target_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['memory', 'research', 'dismissed', 'unrouted']):
            raise ValueError("must be one of enum values ('memory', 'research', 'dismissed', 'unrouted')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CodebaseRouteRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CodebaseRouteRequest from a dict"""
        if obj is None:
            return None
