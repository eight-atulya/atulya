...
class KeyCreateRequest(BaseModel):
    ...
    expires_days: Optional[Annotated[int, Field(le=365, strict=True, ge=1)]] = 90
    description: Optional[Annotated[str, Field(strict=True, max_length=500)]] = None
    __properties: ClassVar[List[str]] = ["name", "expires_days", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "expires_days": obj.get("expires_days") if obj.get("expires_days") is not None else 90,
