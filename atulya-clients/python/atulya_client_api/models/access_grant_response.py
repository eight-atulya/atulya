...
class AccessGrantResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "org_id", "subject_type", "subject_id", "action", "scope_type", "scope_id", "created_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessGrantResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessGrantResponse from a dict"""
        if obj is None:
            return None
