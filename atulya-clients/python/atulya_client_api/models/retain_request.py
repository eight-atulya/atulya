...
class RetainRequest(BaseModel):
    ...
    var_async: Optional[StrictBool] = Field(default=None, description="If true, process asynchronously in background. If false, wait for completion (default: false)", alias="async")
