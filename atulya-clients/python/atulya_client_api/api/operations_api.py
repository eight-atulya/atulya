...
class OperationsApi:
    ...
    async def get_operation_result(
        ...
        _param = self._get_operation_result_serialize(
            bank_id=bank_id,
            operation_id=operation_id,
            authorization=authorization,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def get_operation_result_with_http_info(
        self,
        bank_id: StrictStr,
        operation_id: StrictStr,
        authorization: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OperationResultResponse]:
        """Get operation result
    ...
    @validate_call
    async def get_operation_result_without_preload_content(
        self,
        bank_id: StrictStr,
        operation_id: StrictStr,
        authorization: Optional[StrictStr] = None,
    ...
    def _get_operation_result_serialize(
        self,
        bank_id,
        operation_id,
        authorization,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/default/banks/{bank_id}/operations/{operation_id}/result',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def list_operations(
        ...
        type: Annotated[Optional[StrictStr], Field(description="Filter by operation type: retain, reflect, consolidation, refresh_mental_model, file_convert_retain, codebase_import, codebase_refresh, codebase_approve, webhook_delivery")] = None,
        ...
        :type status: str
        :param type: Filter by operation type: retain, reflect, consolidation, refresh_mental_model, file_convert_retain, codebase_import, codebase_refresh, codebase_approve, webhook_delivery
        :type type: str
