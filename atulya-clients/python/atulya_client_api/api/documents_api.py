...
class DocumentsApi:
    ...
    @validate_call
    async def api_list_chunks_for_document_v1_default_banks_bank_id_documents_document_id_chunks_get(
        self,
        bank_id: StrictStr,
        ...
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of chunks to skip for pagination")] = None,
        ...
        :type limit: int
        :param offset: Number of chunks to skip for pagination
        :type offset: int
        :param authorization:
        ...
        _param = self._api_list_chunks_for_document_v1_default_banks_bank_id_documents_document_id_chunks_get_serialize(
            bank_id=bank_id,
    ...
    @validate_call
    async def api_list_chunks_for_document_v1_default_banks_bank_id_documents_document_id_chunks_get_with_http_info(
        self,
        bank_id: StrictStr,
        document_id: StrictStr,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Maximum number of chunks to return")] = None,
    ...
    @validate_call
    async def api_list_chunks_for_document_v1_default_banks_bank_id_documents_document_id_chunks_get_without_preload_content(
        self,
        bank_id: StrictStr,
        document_id: StrictStr,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Maximum number of chunks to return")] = None,
    ...
    def _api_list_chunks_for_document_v1_default_banks_bank_id_documents_document_id_chunks_get_serialize(
        self,
        bank_id,
        document_id,
        limit,
    ...
    @validate_call
    async def api_list_document_memories_v1_default_banks_bank_id_documents_document_id_memories_get(
        self,
        bank_id: StrictStr,
        document_id: StrictStr,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Maximum number of memory units to return")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of memory units to skip for pagination")] = None,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param document_id: (required)
        :type document_id: str
        :param limit: Maximum number of memory units to return
        :type limit: int
        :param offset: Number of memory units to skip for pagination
        :type offset: int
        :param authorization:
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._api_list_document_memories_v1_default_banks_bank_id_documents_document_id_memories_get_serialize(
            bank_id=bank_id,
            document_id=document_id,
            limit=limit,
            offset=offset,
    ...
    @validate_call
    async def api_list_document_memories_v1_default_banks_bank_id_documents_document_id_memories_get_with_http_info(
        self,
        bank_id: StrictStr,
        document_id: StrictStr,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Maximum number of memory units to return")] = None,
    ...
    @validate_call
    async def api_list_document_memories_v1_default_banks_bank_id_documents_document_id_memories_get_without_preload_content(
        self,
        bank_id: StrictStr,
        document_id: StrictStr,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Maximum number of memory units to return")] = None,
    ...
    def _api_list_document_memories_v1_default_banks_bank_id_documents_document_id_memories_get_serialize(
        self,
        bank_id,
        document_id,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/default/banks/{bank_id}/documents/{document_id}/memories',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
