...
class MemoryApi:
    ...
    async def internet_research(
        self,
        bank_id: StrictStr,
        internet_research_request: InternetResearchRequest,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param bank_id: (required)
        :type bank_id: str
        :param internet_research_request: (required)
        :type internet_research_request: InternetResearchRequest
        :param authorization:
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._internet_research_serialize(
            bank_id=bank_id,
            internet_research_request=internet_research_request,
            authorization=authorization,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def internet_research_with_http_info(
        self,
        bank_id: StrictStr,
        internet_research_request: InternetResearchRequest,
        authorization: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InternetResearchResponse]:
        """Internet research (live web)
    ...
    @validate_call
    async def internet_research_without_preload_content(
        self,
        bank_id: StrictStr,
        internet_research_request: InternetResearchRequest,
        authorization: Optional[StrictStr] = None,
    ...
    def _internet_research_serialize(
        self,
        bank_id,
        ...
        # process the form parameters
        # process the body parameter
        if internet_research_request is not None:
            _body_params = internet_research_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/default/banks/{bank_id}/internet/research',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
