...
class CodebasesApi:
    ...
    @validate_call
    async def import_codebase_file(
        self,
        bank_id: StrictStr,
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="Source file to import")],
        request: Annotated[StrictStr, Field(description="JSON string with CodebaseImportFileRequest model")],
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._import_codebase_file_serialize(
            bank_id=bank_id,
            file=file,
            request=request,
            authorization=authorization,
    ...
    @validate_call
    async def import_codebase_file_with_http_info(
        self,
        bank_id: StrictStr,
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="Source file to import")],
        request: Annotated[StrictStr, Field(description="JSON string with CodebaseImportFileRequest model")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CodebaseImportFileResponse]:
        """Import a single source file as a codebase
    ...
    @validate_call
    async def import_codebase_file_without_preload_content(
        self,
        bank_id: StrictStr,
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="Source file to import")],
        request: Annotated[StrictStr, Field(description="JSON string with CodebaseImportFileRequest model")],
    ...
    def _import_codebase_file_serialize(
        self,
        bank_id,
        file,
        request,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/default/banks/{bank_id}/codebases/import/file',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
