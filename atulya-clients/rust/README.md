...
Auto-generated Rust client library for Atulya — a living algorithm for machine intelligence (MI).
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Search memories
    let search_request = atulya_client::types::SearchRequest {
    ...
    // Store a memory
    let memory_request = atulya_client::types::BatchMemoryRequest {
        items: vec![
            atulya_client::types::MemoryItem {
...
└── target/
    └── debug/build/
        └── atulya-client-.../out/
            └── atulya_client_generated.rs  # Generated code
```
