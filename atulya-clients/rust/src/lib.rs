//! Atulya API Client
//!
//! A Rust client library for Atulya — a living algorithm for machine intelligence (MI).
//!
//! # Example
//!
//! ```rust,no_run
...
include!(concat!(env!("OUT_DIR"), "/atulya_client_generated.rs"));
...
mod tests {
    ...
    async fn test_memory_lifecycle() {
        let api_url = std::env::var("ATULYA_API_URL")
