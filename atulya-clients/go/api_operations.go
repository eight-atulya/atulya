...
func (r ApiGetOperationResultRequest) Authorization(authorization string) ApiGetOperationResultRequest {
	r.authorization = &authorization
	return r
}

func (r ApiGetOperationResultRequest) Execute() (*OperationResultResponse, *http.Response, error) {
	return r.ApiService.GetOperationResultExecute(r)
}

/*
GetOperationResult Get operation result
...
func (a *OperationsAPIService) GetOperationResultExecute(r ApiGetOperationResultRequest) (*OperationResultResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/default/banks/{bank_id}/operations/{operation_id}/result"
	localVarPath = strings.Replace(localVarPath, "{"+"bank_id"+"}", url.PathEscape(parameterValueToString(r.bankId, "bankId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"operation_id"+"}", url.PathEscape(parameterValueToString(r.operationId, "operationId")), -1)
