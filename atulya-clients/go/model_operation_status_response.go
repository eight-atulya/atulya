...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OperationStatusResponse) GetStageOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OperationStatusResponse) HasStage() bool {
...
func (o *OperationStatusResponse) SetStage(v string) {
	o.Stage.Set(&v)
}
// SetStageNil sets the value for Stage to be an explicit nil
func (o *OperationStatusResponse) SetStageNil() {
	o.Stage.Set(nil)
}
