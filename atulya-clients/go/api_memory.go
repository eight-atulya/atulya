...
func (r ApiInternetResearchRequest) InternetResearchRequest(internetResearchRequest InternetResearchRequest) ApiInternetResearchRequest {
	r.internetResearchRequest = &internetResearchRequest
	return r
}

func (r ApiInternetResearchRequest) Authorization(authorization string) ApiInternetResearchRequest {
	r.authorization = &authorization
	return r
}

func (r ApiInternetResearchRequest) Execute() (*InternetResearchResponse, *http.Response, error) {
	return r.ApiService.InternetResearchExecute(r)
}

/*
InternetResearch Internet research (live web)
...
func (a *MemoryAPIService) InternetResearchExecute(r ApiInternetResearchRequest) (*InternetResearchResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/default/banks/{bank_id}/internet/research"
	localVarPath = strings.Replace(localVarPath, "{"+"bank_id"+"}", url.PathEscape(parameterValueToString(r.bankId, "bankId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.internetResearchRequest == nil {
		return localVarReturnValue, nil, reportError("internetResearchRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.internetResearchRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
