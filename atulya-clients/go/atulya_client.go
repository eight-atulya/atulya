...
// Example:
//
//	client := atulya.NewAPIClientWithToken("https://api.example.com", "your-api-token")
...
// Example:
//
//	client := atulya.NewAPIClientWithTimeout("https://api.example.com", "your-api-token", 30*time.Second)
//	resp, _, err := client.MemoryAPI.RetainMemories(ctx, bankID).RetainRequest(req).Execute()
