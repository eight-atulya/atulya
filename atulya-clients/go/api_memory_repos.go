...
func (r ApiForkMemoryRepoBankRequest) MemoryRepoForkBankRequest(memoryRepoForkBankRequest MemoryRepoForkBankRequest) ApiForkMemoryRepoBankRequest {
	r.memoryRepoForkBankRequest = &memoryRepoForkBankRequest
	return r
}

func (r ApiForkMemoryRepoBankRequest) Authorization(authorization string) ApiForkMemoryRepoBankRequest {
	r.authorization = &authorization
	return r
}

func (r ApiForkMemoryRepoBankRequest) Execute() (*MemoryRepoForkBankResponse, *http.Response, error) {
	return r.ApiService.ForkMemoryRepoBankExecute(r)
}
...
func (a *MemoryReposAPIService) ForkMemoryRepoBankExecute(r ApiForkMemoryRepoBankRequest) (*MemoryRepoForkBankResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/default/repos/{repo_id}/fork-bank"
	localVarPath = strings.Replace(localVarPath, "{"+"repo_id"+"}", url.PathEscape(parameterValueToString(r.repoId, "repoId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.memoryRepoForkBankRequest == nil {
		return localVarReturnValue, nil, reportError("memoryRepoForkBankRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.memoryRepoForkBankRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
