...
export interface PluginConfig {
  ...
  embedVersion?: string; // atulya-embed version (default: "latest")
  embedPackagePath?: string; // Local path to atulya package (e.g. '/path/to/atulya')
  ...
  atulyaApiUrl?: string; // External Atulya API URL (skips local daemon when set)
  atulyaApiToken?: string; // API token for external Atulya API authentication
