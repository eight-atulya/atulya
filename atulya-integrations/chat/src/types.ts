...
/**
 * Configuration for withAtulyaChat.
 */
export interface AtulyaChatOptions {
 ...
 */
export interface AtulyaChatContext {
...
/**
 * The handler signature that withAtulyaChat wraps.
 */
export type AtulyaChatHandler<TState = unknown> = (
  thread: ChatThread<TState>,
  message: ChatMessage,
  ctx: AtulyaChatContext
) => void | Promise<void>;
