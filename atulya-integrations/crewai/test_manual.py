"""Manual integration test for atulya-crewai.

Prerequisites:
  1. Atulya API running on localhost:8888 (./scripts/dev/start-api.sh)
...
BANK_ID = "crewai-test"
ATULYA_URL = "http://localhost:8888"

# --- Configure ---

configure(atulya_api_url=ATULYA_URL, verbose=True)
...
reflect_tool = AtulyaReflectTool(bank_id=BANK_ID, budget="mid")
...
recall_task = Task(
    description=(
        ...
        "Use the atulya_reflect tool to check your memories."
    ),
