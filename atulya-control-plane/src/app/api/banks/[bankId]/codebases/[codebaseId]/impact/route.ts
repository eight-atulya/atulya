...
export async function POST(
  ...
  try {
    ...
    const response = await fetch(
      `${DATAPLANE_URL}/v1/default/banks/${bankId}/codebases/${codebaseId}/impact`,
      {
        method: "POST",
    ...
    console.error("Error analyzing codebase impact:", error);
    return NextResponse.json({ error: "Failed to analyze codebase impact" }, { status: 500 });
  }
}
