...
export async function POST(
  ...
  try {
    ...
    const response = await fetch(
      `${DATAPLANE_URL}/v1/default/banks/${bankId}/codebases/${codebaseId}/approve`,
      {
        method: "POST",
    ...
    console.error("Error approving codebase:", error);
    return NextResponse.json({ error: "Failed to approve codebase" }, { status: 500 });
  }
}
