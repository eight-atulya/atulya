...
This test validates that Atulya works correctly when deployed
...
API_PATH = REPO_ROOT / "atulya-api"
COMPOSE_EXAMPLES_PATH = REPO_ROOT / "docker" / "docker-compose" / "nginx"

# Add atulya-api to path for direct API testing
...
class APIServer:
    ...
    def __init__(self, base_path: str | None = None, port: int = 18888):
        ...
        if base_path:
            self.env["ATULYA_API_BASE_PATH"] = base_path
    ...
    def start(self):
        ...
        log_file = f"/tmp/atulya-api-{self.port}.log"
...
class DockerComposeStack:
    ...
    def __init__(self, compose_file: Path, project_name: str = "atulya-test"):
        ...
        self.env["ATULYA_API_LLM_PROVIDER"] = os.environ.get("ATULYA_API_LLM_PROVIDER", "mock")
        self.env["ATULYA_API_LLM_MODEL"] = os.environ.get("ATULYA_API_LLM_MODEL", "mock-model")
...
"""
        ...
        try:
            ...
            with DockerComposeStack(test_compose, project_name="atulya-base-path-test"):
        ...
        async with httpx.AsyncClient(base_url=base_url, timeout=30.0) as client:
            ...
            response = await client.post(
                ...
                json={
                    "items": [
                        {
                            "content": "Atulya supports deployment under custom base paths for reverse proxy scenarios.",
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("Atulya Base Path Integration Tests")
    print("=" * 70)
    print()
