...
Requires:
- ATULYA_API_URL environment variable (e.g., http://localhost:8888)
- A running Atulya API server with MCP enabled
"""
...
def get_mcp_url() -> str:
    ...
    base_url = os.environ.get("ATULYA_API_URL", "http://localhost:8888")
