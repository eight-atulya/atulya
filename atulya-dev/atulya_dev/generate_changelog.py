...
GITHUB_REPO = "eight-atulya/atulya"
GITHUB_RELEASES_URL = f"https://github.com/{GITHUB_REPO}/releases"
GITHUB_COMMIT_URL = f"https://github.com/{GITHUB_REPO}/commit"
REPO_PATH = Path(__file__).parent.parent.parent
CHANGELOG_PATH = REPO_PATH / "atulya-docs" / "src" / "pages" / "changelog.md"
...
def analyze_commits_with_llm(
    ...
    prompt = f"""Analyze the following git commits for release {version} of Atulya (an AI memory system).
