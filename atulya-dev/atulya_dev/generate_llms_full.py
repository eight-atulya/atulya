...
Usage: generate-llms-full (after installing atulya-dev)

Output: atulya-docs/static/llms-full.txt (served at /llms-full.txt)
"""
...
def get_docs_dir() -> Path:
    """Find the atulya-docs directory relative to this script."""
    script_dir = Path(__file__).parent
    return script_dir.parent.parent / "atulya-docs" / "docs"


def get_output_file() -> Path:
    """Get output file path."""
    script_dir = Path(__file__).parent
    return script_dir.parent.parent / "atulya-docs" / "static" / "llms-full.txt"
...
def main():
    ...
    sections.append(f"""# Atulya Documentation

> Agent Memory that Works Like Human Memory

This file contains the complete Atulya documentation for LLM consumption.
Generated: {timestamp}
