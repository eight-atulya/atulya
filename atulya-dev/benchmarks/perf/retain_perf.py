...
Usage:
    # Single file
    uv run python atulya-dev/benchmarks/perf/retain_perf.py --document <file_path> [options]

    # Directory (batches all files)
    uv run python atulya-dev/benchmarks/perf/retain_perf.py --document <dir_path> [options]
"""
...
Examples:
  ...
  uv run python atulya-dev/benchmarks/perf/retain_perf.py \\
