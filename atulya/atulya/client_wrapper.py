"""
Wrapper for Atulya client that adds API namespaces.

Provides organized access to different parts of the Atulya API through
...
class BanksAPI:
    ...
    def __init__(self, client: Atulya):
        self._client = client
    ...
    def list(self):
        """List all banks."""
        from atulya_client.atulya_client import _run_async
...
class AtulyaClient(Atulya):
    """
    Enhanced Atulya client with organized API namespaces.

    This wrapper extends the auto-generated Atulya client with organized
    ...
    Example:
        ...
        client = AtulyaClient(base_url="http://localhost:8888")

        # Core operations (inherited from Atulya)
