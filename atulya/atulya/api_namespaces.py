"""
Defines API namespace classes for organizing client methods.

These classes provide structured and clear access to distinct components of the Atulya API.
Each method ensures that the required daemon is running before executing API operations.
This module is intended for internal use within the Atulya client library.
"""
...
class BanksAPI:
    ...
    def __init__(self, embedded: "AtulyaEmbedded"):
