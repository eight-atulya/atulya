...
def test_ensure_started_calls_manager(embedded_client):
    ...
    # Mock Atulya client constructor
    with patch("atulya.embedded.Atulya") as mock_atulya_class:
        mock_client = Mock()
        mock_atulya_class.return_value = mock_client
        ...
        # Verify Atulya client was created
        mock_atulya_class.assert_called_once_with(base_url="http://localhost:54321")
