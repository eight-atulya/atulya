...
from atulya_api.engine.cross_encoder import RemoteTEICrossEncoder
...
class TestRemoteTEICrossEncoderConfig:
    ...
    def test_create_from_env(self):
        ...
        from atulya_api.engine.cross_encoder import create_cross_encoder_from_env

        with patch.dict(
            os.environ,
            {
                "ATULYA_API_RERANKER_PROVIDER": "tei",
                "ATULYA_API_RERANKER_TEI_URL": "http://test:9000",
                "ATULYA_API_RERANKER_TEI_BATCH_SIZE": "256",
                "ATULYA_API_RERANKER_TEI_MAX_CONCURRENT": "16",
            },
        ):
