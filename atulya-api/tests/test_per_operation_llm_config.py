...
class TestPerOperationLLMConfig:
    ...
    def test_memory_engine_fallback_when_no_per_operation_config(self):
        ...
        retain_provider = os.environ.pop("ATULYA_API_RETAIN_LLM_PROVIDER", None)
        ...
        try:
            ...
            # Restore env vars
            if retain_provider:
                os.environ["ATULYA_API_RETAIN_LLM_PROVIDER"] = retain_provider
            if retain_model:
                os.environ["ATULYA_API_RETAIN_LLM_MODEL"] = retain_model
            if reflect_provider:
...
class TestRetryAndBackoffConfiguration:
    ...
    def test_per_operation_retry_backoff_config_from_env(self):
        ...
        os.environ["ATULYA_API_RETAIN_LLM_MAX_RETRIES"] = "3"
        os.environ["ATULYA_API_RETAIN_LLM_INITIAL_BACKOFF"] = "2.0"
        os.environ["ATULYA_API_RETAIN_LLM_MAX_BACKOFF"] = "120.0"
        os.environ["ATULYA_API_REFLECT_LLM_MAX_RETRIES"] = "5"
        os.environ["ATULYA_API_REFLECT_LLM_INITIAL_BACKOFF"] = "1.5"
        os.environ["ATULYA_API_REFLECT_LLM_MAX_BACKOFF"] = "90.0"
        ...
        try:
            ...
            # Clean up
            os.environ.pop("ATULYA_API_RETAIN_LLM_MAX_RETRIES", None)
            os.environ.pop("ATULYA_API_RETAIN_LLM_INITIAL_BACKOFF", None)
            os.environ.pop("ATULYA_API_RETAIN_LLM_MAX_BACKOFF", None)
            os.environ.pop("ATULYA_API_REFLECT_LLM_MAX_RETRIES", None)
            os.environ.pop("ATULYA_API_REFLECT_LLM_INITIAL_BACKOFF", None)
            os.environ.pop("ATULYA_API_REFLECT_LLM_MAX_BACKOFF", None)
            clear_config_cache()
    ...
    def test_per_operation_retry_backoff_fallback_to_global(self):
        ...
        from atulya_api.config import clear_config_cache, get_config

        # Set only global values
        os.environ["ATULYA_API_LLM_MAX_RETRIES"] = "7"
        os.environ["ATULYA_API_LLM_INITIAL_BACKOFF"] = "3.0"
        os.environ["ATULYA_API_LLM_MAX_BACKOFF"] = "180.0"
        ...
        try:
            ...
            os.environ.pop("ATULYA_API_LLM_MAX_RETRIES", None)
            os.environ.pop("ATULYA_API_LLM_INITIAL_BACKOFF", None)
            os.environ.pop("ATULYA_API_LLM_MAX_BACKOFF", None)
            clear_config_cache()
