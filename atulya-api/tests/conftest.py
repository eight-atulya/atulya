...
def db_url():
    ...
    If ATULYA_API_DATABASE_URL is set, use it directly.
    Otherwise, return None to indicate pg0 should be used (managed by pg0_instance fixture).
    """
    return os.getenv("ATULYA_API_DATABASE_URL")
...
def pg0_db_url(db_url, tmp_path_factory, worker_id):
    ...
    If ATULYA_API_DATABASE_URL is set, uses that directly (no pg0 management).
