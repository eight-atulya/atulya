"""
Test LLM provider with different models using actual Atulya memory operations.
...
from atulya_api.engine.utils import extract_facts
from atulya_api.engine.search.think_utils import reflect
...
async def test_llm_provider_api_methods(provider: str, model: str):
    """
    Test all LLM API methods used by Atulya at runtime.
...
# NOTE: The tests above validate the critical Atulya operations:
#
...
#   - Run your local LLM server OR set ATULYA_API_LLM_PROVIDER/API_KEY/MODEL env vars
#
