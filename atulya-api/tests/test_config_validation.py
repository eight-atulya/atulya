...
def setup_test_env():
    ...
    env_vars_to_save = [
        "ATULYA_API_RETAIN_MAX_COMPLETION_TOKENS",
        "ATULYA_API_RETAIN_CHUNK_SIZE",
...
def test_retain_max_completion_tokens_must_be_greater_than_chunk_size():
    ...
    os.environ["ATULYA_API_RETAIN_MAX_COMPLETION_TOKENS"] = "1000"
    os.environ["ATULYA_API_RETAIN_CHUNK_SIZE"] = "2000"
    os.environ["ATULYA_API_LLM_PROVIDER"] = "mock"

    # Should raise ValueError with helpful message
    with pytest.raises(ValueError) as exc_info:
        AtulyaConfig.from_env()

    error_message = str(exc_info.value)

    # Verify error message contains helpful information
    assert "ATULYA_API_RETAIN_MAX_COMPLETION_TOKENS" in error_message
    assert "1000" in error_message
    assert "ATULYA_API_RETAIN_CHUNK_SIZE" in error_message
    ...
    assert "Increase ATULYA_API_RETAIN_MAX_COMPLETION_TOKENS" in error_message
...
def test_retain_max_completion_tokens_equal_to_chunk_size_fails():
    ...
    # Set invalid config: max_completion_tokens == chunk_size
    os.environ["ATULYA_API_RETAIN_MAX_COMPLETION_TOKENS"] = "3000"
    os.environ["ATULYA_API_RETAIN_CHUNK_SIZE"] = "3000"
    os.environ["ATULYA_API_LLM_PROVIDER"] = "mock"
...
def test_valid_retain_config_succeeds():
    ...
    os.environ["ATULYA_API_RETAIN_MAX_COMPLETION_TOKENS"] = "64000"
    os.environ["ATULYA_API_RETAIN_CHUNK_SIZE"] = "3000"
    os.environ["ATULYA_API_LLM_PROVIDER"] = "mock"
