...
class StaticConfigProxy:
    """
    Proxy that wraps AtulyaConfig and only allows access to static (non-configurable) fields.
    ...
    def __init__(self, config: "AtulyaConfig"):
        object.__setattr__(self, "_config", config)
        object.__setattr__(self, "_configurable_fields", AtulyaConfig.get_configurable_fields())
...
def normalize_config_key(key: str) -> str:
    ...
    Examples:
        ATULYA_API_LLM_PROVIDER -> llm_provider
        LLM_MODEL -> llm_model
    ...
    """
    if key.startswith("ATULYA_API_"):
        key = key[len("ATULYA_API_") :]
    return key.lower()
...
def normalize_config_dict(config: dict[str, Any]) -> dict[str, Any]:
    ...
    - Env var format: {"ATULYA_API_LLM_PROVIDER": "openai"}
...
ENV_DATABASE_URL = "ATULYA_API_DATABASE_URL"
ENV_DATABASE_SCHEMA = "ATULYA_API_DATABASE_SCHEMA"
ENV_LLM_PROVIDER = "ATULYA_API_LLM_PROVIDER"
ENV_LLM_API_KEY = "ATULYA_API_LLM_API_KEY"
ENV_LLM_MODEL = "ATULYA_API_LLM_MODEL"
ENV_LLM_BASE_URL = "ATULYA_API_LLM_BASE_URL"
ENV_LLM_MAX_CONCURRENT = "ATULYA_API_LLM_MAX_CONCURRENT"
ENV_LLM_MAX_RETRIES = "ATULYA_API_LLM_MAX_RETRIES"
ENV_LLM_INITIAL_BACKOFF = "ATULYA_API_LLM_INITIAL_BACKOFF"
ENV_LLM_MAX_BACKOFF = "ATULYA_API_LLM_MAX_BACKOFF"
...
ENV_RETAIN_LLM_API_KEY = "ATULYA_API_RETAIN_LLM_API_KEY"
ENV_RETAIN_LLM_MODEL = "ATULYA_API_RETAIN_LLM_MODEL"
ENV_RETAIN_LLM_BASE_URL = "ATULYA_API_RETAIN_LLM_BASE_URL"
ENV_RETAIN_LLM_MAX_CONCURRENT = "ATULYA_API_RETAIN_LLM_MAX_CONCURRENT"
ENV_RETAIN_LLM_MAX_RETRIES = "ATULYA_API_RETAIN_LLM_MAX_RETRIES"
ENV_RETAIN_LLM_INITIAL_BACKOFF = "ATULYA_API_RETAIN_LLM_INITIAL_BACKOFF"
ENV_RETAIN_LLM_MAX_BACKOFF = "ATULYA_API_RETAIN_LLM_MAX_BACKOFF"
ENV_RETAIN_LLM_TIMEOUT = "ATULYA_API_RETAIN_LLM_TIMEOUT"

ENV_REFLECT_LLM_PROVIDER = "ATULYA_API_REFLECT_LLM_PROVIDER"
ENV_REFLECT_LLM_API_KEY = "ATULYA_API_REFLECT_LLM_API_KEY"
ENV_REFLECT_LLM_MODEL = "ATULYA_API_REFLECT_LLM_MODEL"
ENV_REFLECT_LLM_BASE_URL = "ATULYA_API_REFLECT_LLM_BASE_URL"
ENV_REFLECT_LLM_MAX_CONCURRENT = "ATULYA_API_REFLECT_LLM_MAX_CONCURRENT"
ENV_REFLECT_LLM_MAX_RETRIES = "ATULYA_API_REFLECT_LLM_MAX_RETRIES"
ENV_REFLECT_LLM_INITIAL_BACKOFF = "ATULYA_API_REFLECT_LLM_INITIAL_BACKOFF"
ENV_REFLECT_LLM_MAX_BACKOFF = "ATULYA_API_REFLECT_LLM_MAX_BACKOFF"
ENV_REFLECT_LLM_TIMEOUT = "ATULYA_API_REFLECT_LLM_TIMEOUT"

ENV_CONSOLIDATION_LLM_PROVIDER = "ATULYA_API_CONSOLIDATION_LLM_PROVIDER"
ENV_CONSOLIDATION_LLM_API_KEY = "ATULYA_API_CONSOLIDATION_LLM_API_KEY"
ENV_CONSOLIDATION_LLM_MODEL = "ATULYA_API_CONSOLIDATION_LLM_MODEL"
ENV_CONSOLIDATION_LLM_BASE_URL = "ATULYA_API_CONSOLIDATION_LLM_BASE_URL"
ENV_CONSOLIDATION_LLM_MAX_CONCURRENT = "ATULYA_API_CONSOLIDATION_LLM_MAX_CONCURRENT"
ENV_CONSOLIDATION_LLM_MAX_RETRIES = "ATULYA_API_CONSOLIDATION_LLM_MAX_RETRIES"
...
ENV_EMBEDDINGS_LOCAL_TRUST_REMOTE_CODE = "ATULYA_API_EMBEDDINGS_LOCAL_TRUST_REMOTE_CODE"
ENV_EMBEDDINGS_TEI_URL = "ATULYA_API_EMBEDDINGS_TEI_URL"
ENV_EMBEDDINGS_OPENAI_API_KEY = "ATULYA_API_EMBEDDINGS_OPENAI_API_KEY"
ENV_EMBEDDINGS_OPENAI_MODEL = "ATULYA_API_EMBEDDINGS_OPENAI_MODEL"
ENV_EMBEDDINGS_OPENAI_BASE_URL = "ATULYA_API_EMBEDDINGS_OPENAI_BASE_URL"
...
ENV_COHERE_API_KEY = "ATULYA_API_COHERE_API_KEY"

# LiteLLM configuration (separate for embeddings and reranker)
ENV_EMBEDDINGS_LITELLM_API_BASE = "ATULYA_API_EMBEDDINGS_LITELLM_API_BASE"
ENV_EMBEDDINGS_LITELLM_API_KEY = "ATULYA_API_EMBEDDINGS_LITELLM_API_KEY"
ENV_EMBEDDINGS_LITELLM_MODEL = "ATULYA_API_EMBEDDINGS_LITELLM_MODEL"
ENV_RERANKER_LITELLM_API_BASE = "ATULYA_API_RERANKER_LITELLM_API_BASE"
ENV_RERANKER_LITELLM_API_KEY = "ATULYA_API_RERANKER_LITELLM_API_KEY"
ENV_RERANKER_LITELLM_MODEL = "ATULYA_API_RERANKER_LITELLM_MODEL"

# LiteLLM SDK configuration (direct API access, no proxy needed)
ENV_EMBEDDINGS_LITELLM_SDK_API_KEY = "ATULYA_API_EMBEDDINGS_LITELLM_SDK_API_KEY"
ENV_EMBEDDINGS_LITELLM_SDK_MODEL = "ATULYA_API_EMBEDDINGS_LITELLM_SDK_MODEL"
ENV_EMBEDDINGS_LITELLM_SDK_API_BASE = "ATULYA_API_EMBEDDINGS_LITELLM_SDK_API_BASE"
ENV_RERANKER_LITELLM_SDK_API_KEY = "ATULYA_API_RERANKER_LITELLM_SDK_API_KEY"
ENV_RERANKER_LITELLM_SDK_MODEL = "ATULYA_API_RERANKER_LITELLM_SDK_MODEL"
ENV_RERANKER_LITELLM_SDK_API_BASE = "ATULYA_API_RERANKER_LITELLM_SDK_API_BASE"

# Deprecated: Legacy shared LiteLLM config (for backward compatibility)
ENV_LITELLM_API_BASE = "ATULYA_API_LITELLM_API_BASE"
ENV_LITELLM_API_KEY = "ATULYA_API_LITELLM_API_KEY"

ENV_RERANKER_PROVIDER = "ATULYA_API_RERANKER_PROVIDER"
ENV_RERANKER_LOCAL_MODEL = "ATULYA_API_RERANKER_LOCAL_MODEL"
ENV_RERANKER_LOCAL_FORCE_CPU = "ATULYA_API_RERANKER_LOCAL_FORCE_CPU"
ENV_RERANKER_LOCAL_MAX_CONCURRENT = "ATULYA_API_RERANKER_LOCAL_MAX_CONCURRENT"
ENV_RERANKER_LOCAL_TRUST_REMOTE_CODE = "ATULYA_API_RERANKER_LOCAL_TRUST_REMOTE_CODE"
...
ENV_RERANKER_ZEROENTROPY_API_KEY = "ATULYA_API_RERANKER_ZEROENTROPY_API_KEY"
ENV_RERANKER_ZEROENTROPY_MODEL = "ATULYA_API_RERANKER_ZEROENTROPY_MODEL"

ENV_VECTOR_EXTENSION = "ATULYA_API_VECTOR_EXTENSION"
ENV_TEXT_SEARCH_EXTENSION = "ATULYA_API_TEXT_SEARCH_EXTENSION"

ENV_HOST = "ATULYA_API_HOST"
ENV_PORT = "ATULYA_API_PORT"
ENV_BASE_PATH = "ATULYA_API_BASE_PATH"
ENV_LOG_LEVEL = "ATULYA_API_LOG_LEVEL"
ENV_LOG_FORMAT = "ATULYA_API_LOG_FORMAT"
ENV_WORKERS = "ATULYA_API_WORKERS"
ENV_MCP_ENABLED = "ATULYA_API_MCP_ENABLED"
ENV_MCP_ENABLED_TOOLS = "ATULYA_API_MCP_ENABLED_TOOLS"
ENV_ENABLE_BANK_CONFIG_API = "ATULYA_API_ENABLE_BANK_CONFIG_API"
ENV_GRAPH_RETRIEVER = "ATULYA_API_GRAPH_RETRIEVER"
ENV_MPFP_TOP_K_NEIGHBORS = "ATULYA_API_MPFP_TOP_K_NEIGHBORS"
ENV_RECALL_MAX_CONCURRENT = "ATULYA_API_RECALL_MAX_CONCURRENT"
ENV_RECALL_CONNECTION_BUDGET = "ATULYA_API_RECALL_CONNECTION_BUDGET"
ENV_MENTAL_MODEL_REFRESH_CONCURRENCY = "ATULYA_API_MENTAL_MODEL_REFRESH_CONCURRENCY"

# OpenTelemetry tracing configuration
ENV_OTEL_TRACES_ENABLED = "ATULYA_API_OTEL_TRACES_ENABLED"
ENV_OTEL_EXPORTER_OTLP_ENDPOINT = "ATULYA_API_OTEL_EXPORTER_OTLP_ENDPOINT"
ENV_OTEL_EXPORTER_OTLP_HEADERS = "ATULYA_API_OTEL_EXPORTER_OTLP_HEADERS"
ENV_OTEL_SERVICE_NAME = "ATULYA_API_OTEL_SERVICE_NAME"
ENV_OTEL_DEPLOYMENT_ENVIRONMENT = "ATULYA_API_OTEL_DEPLOYMENT_ENVIRONMENT"

# Vertex AI configuration
ENV_LLM_VERTEXAI_PROJECT_ID = "ATULYA_API_LLM_VERTEXAI_PROJECT_ID"
ENV_LLM_VERTEXAI_REGION = "ATULYA_API_LLM_VERTEXAI_REGION"
ENV_LLM_VERTEXAI_SERVICE_ACCOUNT_KEY = "ATULYA_API_LLM_VERTEXAI_SERVICE_ACCOUNT_KEY"

# Gemini safety settings
ENV_LLM_GEMINI_SAFETY_SETTINGS = "ATULYA_API_LLM_GEMINI_SAFETY_SETTINGS"

# Retain settings
ENV_RETAIN_MAX_COMPLETION_TOKENS = "ATULYA_API_RETAIN_MAX_COMPLETION_TOKENS"
ENV_RETAIN_CHUNK_SIZE = "ATULYA_API_RETAIN_CHUNK_SIZE"
ENV_RETAIN_EXTRACT_CAUSAL_LINKS = "ATULYA_API_RETAIN_EXTRACT_CAUSAL_LINKS"
ENV_RETAIN_EXTRACTION_MODE = "ATULYA_API_RETAIN_EXTRACTION_MODE"
ENV_RETAIN_MISSION = "ATULYA_API_RETAIN_MISSION"
ENV_RETAIN_CUSTOM_INSTRUCTIONS = "ATULYA_API_RETAIN_CUSTOM_INSTRUCTIONS"
ENV_RETAIN_BATCH_TOKENS = "ATULYA_API_RETAIN_BATCH_TOKENS"
ENV_RETAIN_ENTITY_LOOKUP = "ATULYA_API_RETAIN_ENTITY_LOOKUP"
...
ENV_FILE_STORAGE_S3_REGION = "ATULYA_API_FILE_STORAGE_S3_REGION"
ENV_FILE_STORAGE_S3_ENDPOINT = "ATULYA_API_FILE_STORAGE_S3_ENDPOINT"
ENV_FILE_STORAGE_S3_ACCESS_KEY_ID = "ATULYA_API_FILE_STORAGE_S3_ACCESS_KEY_ID"
ENV_FILE_STORAGE_S3_SECRET_ACCESS_KEY = "ATULYA_API_FILE_STORAGE_S3_SECRET_ACCESS_KEY"
ENV_FILE_STORAGE_GCS_BUCKET = "ATULYA_API_FILE_STORAGE_GCS_BUCKET"
ENV_FILE_STORAGE_GCS_SERVICE_ACCOUNT_KEY = "ATULYA_API_FILE_STORAGE_GCS_SERVICE_ACCOUNT_KEY"
ENV_FILE_STORAGE_AZURE_CONTAINER = "ATULYA_API_FILE_STORAGE_AZURE_CONTAINER"
ENV_FILE_STORAGE_AZURE_ACCOUNT_NAME = "ATULYA_API_FILE_STORAGE_AZURE_ACCOUNT_NAME"
ENV_FILE_STORAGE_AZURE_ACCOUNT_KEY = "ATULYA_API_FILE_STORAGE_AZURE_ACCOUNT_KEY"
ENV_FILE_PARSER = "ATULYA_API_FILE_PARSER"
ENV_FILE_PARSER_ALLOWLIST = "ATULYA_API_FILE_PARSER_ALLOWLIST"
ENV_FILE_PARSER_IRIS_TOKEN = "ATULYA_API_FILE_PARSER_IRIS_TOKEN"
ENV_FILE_PARSER_IRIS_ORG_ID = "ATULYA_API_FILE_PARSER_IRIS_ORG_ID"
ENV_FILE_CONVERSION_MAX_BATCH_SIZE_MB = "ATULYA_API_FILE_CONVERSION_MAX_BATCH_SIZE_MB"
...
ENV_CONSOLIDATION_BATCH_SIZE = "ATULYA_API_CONSOLIDATION_BATCH_SIZE"
ENV_CONSOLIDATION_LLM_BATCH_SIZE = "ATULYA_API_CONSOLIDATION_LLM_BATCH_SIZE"
ENV_CONSOLIDATION_MAX_TOKENS = "ATULYA_API_CONSOLIDATION_MAX_TOKENS"
ENV_CONSOLIDATION_SOURCE_FACTS_MAX_TOKENS = "ATULYA_API_CONSOLIDATION_SOURCE_FACTS_MAX_TOKENS"
...
ENV_WEBHOOK_SECRET = "ATULYA_API_WEBHOOK_SECRET"
...
# Database migrations
ENV_RUN_MIGRATIONS_ON_STARTUP = "ATULYA_API_RUN_MIGRATIONS_ON_STARTUP"

# Database connection pool
ENV_DB_POOL_MIN_SIZE = "ATULYA_API_DB_POOL_MIN_SIZE"
ENV_DB_POOL_MAX_SIZE = "ATULYA_API_DB_POOL_MAX_SIZE"
ENV_DB_COMMAND_TIMEOUT = "ATULYA_API_DB_COMMAND_TIMEOUT"
ENV_DB_ACQUIRE_TIMEOUT = "ATULYA_API_DB_ACQUIRE_TIMEOUT"

# Worker configuration (distributed task processing)
ENV_WORKER_ENABLED = "ATULYA_API_WORKER_ENABLED"
ENV_WORKER_ID = "ATULYA_API_WORKER_ID"
ENV_WORKER_POLL_INTERVAL_MS = "ATULYA_API_WORKER_POLL_INTERVAL_MS"
ENV_WORKER_MAX_RETRIES = "ATULYA_API_WORKER_MAX_RETRIES"
...
ENV_BRAIN_CACHE_DIR = "ATULYA_API_BRAIN_CACHE_DIR"
ENV_BRAIN_DEFAULT_FILE_NAME = "ATULYA_API_BRAIN_DEFAULT_FILE_NAME"
ENV_BRAIN_NATIVE_LIBRARY_PATH = "ATULYA_API_BRAIN_NATIVE_LIBRARY_PATH"
ENV_BRAIN_CIRCUIT_BREAKER_THRESHOLD = "ATULYA_API_BRAIN_CIRCUIT_BREAKER_THRESHOLD"
ENV_BRAIN_STARTUP_WARMUP = "ATULYA_API_BRAIN_STARTUP_WARMUP"
ENV_BRAIN_HARDWARE_TIER = "ATULYA_API_BRAIN_HARDWARE_TIER"
ENV_BRAIN_PREDICTION_MODE = "ATULYA_API_BRAIN_PREDICTION_MODE"
ENV_BRAIN_IMPORT_EXPORT_ENABLED = "ATULYA_API_BRAIN_IMPORT_EXPORT_ENABLED"
ENV_BRAIN_MAX_FILE_SIZE_MB = "ATULYA_API_BRAIN_MAX_FILE_SIZE_MB"
ENV_WORKER_SUB_ROUTINE_MAX_SLOTS = "ATULYA_API_WORKER_SUB_ROUTINE_MAX_SLOTS"

# Reflect agent settings
ENV_REFLECT_MAX_ITERATIONS = "ATULYA_API_REFLECT_MAX_ITERATIONS"
ENV_REFLECT_MAX_CONTEXT_TOKENS = "ATULYA_API_REFLECT_MAX_CONTEXT_TOKENS"
ENV_REFLECT_MISSION = "ATULYA_API_REFLECT_MISSION"

# Disposition settings
ENV_DISPOSITION_SKEPTICISM = "ATULYA_API_DISPOSITION_SKEPTICISM"
ENV_DISPOSITION_LITERALISM = "ATULYA_API_DISPOSITION_LITERALISM"
ENV_DISPOSITION_EMPATHY = "ATULYA_API_DISPOSITION_EMPATHY"
...
DEFAULT_BRAIN_CACHE_DIR = "~/.atulya/brain"
DEFAULT_BRAIN_DEFAULT_FILE_NAME = "brain.atulya"
DEFAULT_BRAIN_NATIVE_LIBRARY_PATH = None
DEFAULT_BRAIN_CIRCUIT_BREAKER_THRESHOLD = 3
DEFAULT_BRAIN_STARTUP_WARMUP = False
DEFAULT_BRAIN_HARDWARE_TIER = "balanced"
DEFAULT_BRAIN_PREDICTION_MODE = "histogram"
DEFAULT_BRAIN_IMPORT_EXPORT_ENABLED = False
DEFAULT_BRAIN_MAX_FILE_SIZE_MB = 50
...
DEFAULT_OTEL_SERVICE_NAME = "atulya-api"
...
# Dream/Trance defaults (bank-configurable under the "dream" key)
...
class AtulyaConfig:
    ...
    # Dream/Trance settings (nested bank-level runtime config)
    ...
    brain_enabled: bool
    brain_cache_dir: str
    brain_default_file_name: str
    brain_native_library_path: str | None
    brain_circuit_breaker_threshold: int
    brain_startup_warmup: bool
    brain_hardware_tier: str
    brain_prediction_mode: str
    brain_import_export_enabled: bool
    brain_max_file_size_mb: int
    ...
    def validate(self) -> None:
        ...
        if self.retain_max_completion_tokens <= self.retain_chunk_size:
            raise ValueError(
                f"Invalid configuration: ATULYA_API_RETAIN_MAX_COMPLETION_TOKENS "
                f"({self.retain_max_completion_tokens}) must be greater than "
                f"ATULYA_API_RETAIN_CHUNK_SIZE ({self.retain_chunk_size}). "
                f"\n\nYou have two options to fix this:"
                f"\n  1. Increase ATULYA_API_RETAIN_MAX_COMPLETION_TOKENS to a value > {self.retain_chunk_size}"
        ...
        valid_brain_tiers = ("low", "balanced", "high")
        if self.brain_hardware_tier not in valid_brain_tiers:
            raise ValueError(
                f"Invalid brain_hardware_tier: {self.brain_hardware_tier}. Must be one of: {', '.join(valid_brain_tiers)}"
            )
        valid_prediction_modes = ("histogram", "kalman_lite", "hmm_lite")
        if self.brain_prediction_mode not in valid_prediction_modes:
            raise ValueError(
                "Invalid brain_prediction_mode: "
                f"{self.brain_prediction_mode}. Must be one of: {', '.join(valid_prediction_modes)}"
            )
    ...
    def from_env(cls) -> "AtulyaConfig":
        ...
        config = cls(
            ...
            worker_sub_routine_max_slots=int(
                os.getenv(ENV_WORKER_SUB_ROUTINE_MAX_SLOTS, str(DEFAULT_WORKER_SUB_ROUTINE_MAX_SLOTS))
            ),
            # Atulya brain / sub_routine runtime
            brain_enabled=os.getenv(ENV_BRAIN_ENABLED, str(DEFAULT_BRAIN_ENABLED)).lower() == "true",
            brain_cache_dir=os.getenv(ENV_BRAIN_CACHE_DIR, DEFAULT_BRAIN_CACHE_DIR),
            brain_default_file_name=os.getenv(ENV_BRAIN_DEFAULT_FILE_NAME, DEFAULT_BRAIN_DEFAULT_FILE_NAME),
            brain_native_library_path=os.getenv(ENV_BRAIN_NATIVE_LIBRARY_PATH) or DEFAULT_BRAIN_NATIVE_LIBRARY_PATH,
            brain_circuit_breaker_threshold=int(
                os.getenv(ENV_BRAIN_CIRCUIT_BREAKER_THRESHOLD, str(DEFAULT_BRAIN_CIRCUIT_BREAKER_THRESHOLD))
            ),
            brain_startup_warmup=os.getenv(ENV_BRAIN_STARTUP_WARMUP, str(DEFAULT_BRAIN_STARTUP_WARMUP)).lower()
            == "true",
            brain_hardware_tier=os.getenv(ENV_BRAIN_HARDWARE_TIER, DEFAULT_BRAIN_HARDWARE_TIER).lower(),
            brain_prediction_mode=os.getenv(ENV_BRAIN_PREDICTION_MODE, DEFAULT_BRAIN_PREDICTION_MODE).lower(),
            brain_import_export_enabled=os.getenv(
                ENV_BRAIN_IMPORT_EXPORT_ENABLED, str(DEFAULT_BRAIN_IMPORT_EXPORT_ENABLED)
            ).lower()
            == "true",
            ...
            dream=DEFAULT_DREAM_CONFIG.copy(),
    ...
    def log_config(self) -> None:
        ...
        logger.info(
            ...
            self.brain_enabled,
            self.brain_cache_dir,
            self.brain_startup_warmup,
            self.brain_hardware_tier,
            self.brain_prediction_mode,
            self.brain_import_export_enabled,
        )
...
_config_cache: AtulyaConfig | None = None
...
def _get_raw_config() -> AtulyaConfig:
    """
    ...
    if _config_cache is None:
        _config_cache = AtulyaConfig.from_env()
