"""Base Extension class for all Atulya extensions."""
...
class Extension(ABC):
    """
    Base class for all Atulya extensions.

    Extensions are loaded via environment variables and receive configuration
    from prefixed environment variables.

    Example:
        ATULYA_API_MY_EXTENSION=mypackage.ext:MyExtension
        ATULYA_API_MY_SOME_CONFIG=value
