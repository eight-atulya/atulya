...
if TYPE_CHECKING:
    from atulya_api.engine.interface import MemoryEngineInterface
...
class ExtensionContext(ABC):
    ...
    Built-in implementation:
        atulya_api.extensions.builtin.context.DefaultExtensionContext
...
class DefaultExtensionContext(ExtensionContext):
    ...
    async def run_migration(self, schema: str) -> None:
        ...
        from atulya_api.migrations import (
