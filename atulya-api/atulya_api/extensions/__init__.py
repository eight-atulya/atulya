"""
Atulya Extensions System.

Extensions allow customizing and extending Atulya behavior without modifying core code.
...
Example:
    ...
    ATULYA_API_OPERATION_VALIDATOR_MAX_RETRIES=3

    ATULYA_API_HTTP_EXTENSION=mypackage.http:MyHttpExtension
    ATULYA_API_HTTP_SOME_CONFIG=value
...
from atulya_api.extensions.builtin import ApiKeyTenantExtension, SupabaseTenantExtension
from atulya_api.extensions.context import DefaultExtensionContext, ExtensionContext
from atulya_api.extensions.http import HttpExtension
...
from atulya_api.extensions.tenant import (
    AuthenticationError,
    Tenant,
    TenantContext,
    TenantExtension,
