...
class EntityResolver:
    ...
    async def _resolve_from_candidates(
        ...
        if entities_to_create:
            ...
            # mention_count starts at 0 here; flush_pending_stats() is the sole source
            # of truth for mention counting.
            ...
            # Assign entity IDs back and queue one stat per original mention so
            # mention_count reflects true mention frequency in the batch.
