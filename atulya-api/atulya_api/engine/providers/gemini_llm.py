...
class GeminiLLM(LLMInterface):
    ...
    def _init_vertexai(self, **kwargs: Any) -> None:
        ...
        if not project_id:
            raise ValueError(
                "ATULYA_API_LLM_VERTEXAI_PROJECT_ID is required for Vertex AI provider. Set it to your GCP project ID."
            )
    ...
    async def call(
        ...
        Args:
            ...
            max_completion_tokens: Maximum tokens in response. Forwarded to
                Gemini's ``GenerateContentConfig.max_output_tokens``.
        ...
        for attempt in range(max_retries + 1):
            try:
                ...
                from atulya_api.tracing import _serialize_for_span
    ...
    async def call_with_tools(
        ...
        Args:
            ...
            max_completion_tokens: Maximum tokens. Forwarded to Gemini's
