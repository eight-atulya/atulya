...
- New mission-relevant topic → CREATE a new observation (source_fact_ids)
...
MISSION OVERRIDE:
- The MISSION defines what is valuable for this bank.
- If a generic heuristic conflicts with the MISSION, follow the MISSION.
- When mission-relevant, timestamped actions and transient-looking session events are valid facts to keep."""
...
Input facts:
[a1b2c3d4-e5f6-7890-abcd-ef1234567890] Anurag and Akshay planned a coffee-focused product sync through 8 this weekend | Involving: Anurag Atulya, Akshay Bhandari (occurred_start=2024-01-15, mentioned_at=2024-01-15)
[b2c3d4e5-f6a7-8901-bcde-f12345678901] Paritosh and Anurag discussed building memory systems for agentic AI and machine intelligence | Involving: Paritosh Sapre, Anurag Atulya (occurred_start=2024-01-20, mentioned_at=2024-01-20)

Good observation text — clean prose, no metadata, each fact tracked distinctly:
  "Anurag and Akshay regularly align over coffee-driven product discussions through 8."
  "Paritosh and Anurag collaborate on memory systems for agentic AI and machine intelligence."

Bad observation text — NEVER do this (verbatim copy of fact text with metadata):
  "Anurag and Akshay planned a coffee-focused product sync through 8 this weekend | Involving: Anurag Atulya, Akshay Bhandari (occurred_start=2024-01-15, mentioned_at=2024-01-15)"
...
{{"creates": [{{"text": "Anurag and Akshay regularly align over coffee-driven product discussions through 8.", "source_fact_ids": ["a1b2c3d4-e5f6-7890-abcd-ef1234567890"]}}, {{"text": "Paritosh and Anurag collaborate on memory systems for agentic AI and machine intelligence.", "source_fact_ids": ["b2c3d4e5-f6a7-8901-bcde-f12345678901"]}}],
  "updates": [{{"text": "Antara Das and Anurag share an 8 Oct birthday context used for personal timeline reminders", "observation_id": "c3d4e5f6-a7b8-9012-cdef-123456789012", "source_fact_ids": ["d4e5f6a7-b8c9-0123-defa-234567890123"]}}],
