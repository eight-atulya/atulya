...
def _sanitize_text(text: str | None) -> str | None:
    """Thin wrapper around the canonical LLM output sanitizer."""
...
✅ Preferences: likes, dislikes, habits, interests (e.g., "Anurag likes coffee")
...
Input: "Anurag has 5 years of Kubernetes experience and holds CKA certification. She's been leading the infrastructure team since March. By the way, she prefers dark roast coffee."

Output: ONLY 2 facts (skip coffee preference - too trivial):
1. what="Anurag has 5 years Kubernetes experience, CKA certified", who="Anurag", entities=["Anurag", "Kubernetes", "CKA"]
2. what="Anurag leads infrastructure team since March", who="Anurag", entities=["Anurag", "infrastructure"]
...
- Examples: "I went to a pottery workshop" → event
           "Anurag visited Paris in February" → event
...
- Examples: "I love Italian food" → conversation
           "Anurag works at Google" → conversation
...
- People names (Emily, Anurag, Dr. Smith)
        ...
        try:
            ...
            if any(
                ...
                raise ValueError(
                    ...
                    f"  2. Decrease ATULYA_API_RETAIN_MAX_COMPLETION_TOKENS to a value your model supports\n"
