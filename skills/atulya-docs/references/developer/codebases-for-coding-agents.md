...
For a bank tuned to this workflow (retain/reflect/observations plus optional starter guides), create the bank with **`bank_preset: "codebase"`** — see [Bank presets](/developer/bank-presets).
