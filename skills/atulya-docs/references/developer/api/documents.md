...
When you retain content, Atulya splits it into chunks before extracting facts. These chunks are stored alongside the extracted memories, preserving the original text segments.
...
atulya memory retain my-bank "Meeting notes content..." --doc-id notes-2024-03-15

# Batch retain from files
atulya memory retain-files my-bank docs/
```
...
```bash
# Original
atulya memory retain my-bank "Project deadline: March 31" --doc-id project-plan

# Update
atulya memory retain my-bank "Project deadline: April 15 (extended)" --doc-id project-plan
```
...
```python
from atulya_client_api import ApiClient, Configuration
from atulya_client_api.api import DocumentsApi
...
```bash
atulya document get my-bank meeting-2024-03-15
```
...
```bash
atulya document delete my-bank meeting-2024-03-15
```
...
```bash
# List all documents
atulya document list my-bank

# Filter by ID substring
atulya document list my-bank --q report

# Filter by tags
atulya document list my-bank --tags team-a --tags team-b
```
