...
You don't need to pre-create a bank. Atulya will automatically create it with default settings when you first use it.
...
Only applies when `ATULYA_API_LLM_PROVIDER` is `gemini` or `vertexai`.
