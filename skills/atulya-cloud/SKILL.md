---
name: atulya-cloud
description: Store team knowledge, project conventions, and learnings from tasks. Use to remember what works and recall context before new tasks. Connects to Atulya Cloud. (user)
---

# Atulya Memory Skill (Cloud)

You have persistent memory via **Atulya Cloud**. This memory bank is **shared with the team**, so knowledge stored here benefits everyone working on this codebase.
...
2. **Create the config file** - ask the user for their **API Key** (get it from https://ui.atulya.eightengine.com):
   ```bash
   mkdir -p ~/.atulya
